...
@section('content_header')
    <h1><a href="{{route('admin.section.index')}}"><i class="fas fa-door-open"></i></a> Crear Credito a:</h1>
@stop
        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.credit.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="Pregunta" required>
                </div>
                <div class="form-group">
                    <label for="role">Colocar el rol de la persona</label>
                    <input type="text" class="form-control" name="role" placeholder="Pregunta" required>
                </div>
                <div class="form-group">
                    <label for="description">Colocar una descripcion</label>
                    <input type="text" class="form-control" name="description" placeholder="Pregunta" required>
                </div>
                <div class="form-group">
